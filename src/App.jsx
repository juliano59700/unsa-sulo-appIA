...
import {
  ...
  Sun, Moon, ArrowLeft, BookOpen, Hash, Stethoscope, HandMetal,
      ...
      <div className="w-full max-w-md rounded-t-3xl p-6 pb-10" style={{ background: 'var(--bg)', borderTop: '1px solid var(--border)' }}>
        ...
        <div className="space-y-2 mb-4">
          {[
            ...
            <button key={c.t} onClick={onClose} className="w-full text-left p-3 rounded-xl tap-scale" style={cardStyle}>
  ...
  return (
    <div className={`font-body theme-${theme} min-h-screen`} style={{ background: 'var(--bg)', color: 'var(--text)' }}>
      ...
      <div className="max-w-md mx-auto relative">
        ...
        {urgence && <UrgenceModal onClose={() => setUrgence(false)} />}
        {showAdminLogin && (
          <AdminLogin
